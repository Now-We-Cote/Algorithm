...
const solution = (firstString, secondString) => {
  const sortedFirstString = objSort(arrToObj([...firstString]))
  const sortedSecondString = objSort(arrToObj([...secondString]))

  return JSON.stringify(sortedFirstString) === JSON.stringify(sortedSecondString) ? 'YES' : 'No'
