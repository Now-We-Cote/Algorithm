 ...
 *
 * 입력 예시 - 9, [32, 55, 62, 20, 250, 370, 200, 30, 100]
 *
 * 출력 예시 - 23 2 73 2 3
 */
...
const solution = (num, numArr) => {
    return numArr.reduce( (result, num) => {
        const reverseNum = reverseInteger(num)
...
const test = solution(9, [32, 55, 62, 20, 250, 370, 200, 30, 100]);
console.log(test);