...
// 문제 - 한 개의 회의실이 있는데 이를 사용하고자 하는 n개의 회의들에 대하여 회의실 사용표를 만들 려고 한다.
...
// 입력 예시 1 - 5, [[1, 4], [2, 3], [3, 5], [4, 6], [5, 7]] -> [2,3], [1,4], [3,5], [4,6], [5,7]

// 출력 예시 1 - 3

// 입력 예시 2 - 3, [[3, 3], [1, 3], [2, 3]] -> [[1,3], [2,3], [3,3]]
...

{
  const solution = (N, meetings) => {
    ...
    for (const meeting of sortMeetings) {
